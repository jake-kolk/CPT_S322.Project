...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_mealPlanAddRecipeButton_clicked",
        "on_mealPlanRecipesList_itemClicked",
        "on_mealPlanCalender_selectionChanged",
        "on_mealPlanRemoveRecipeButton_clicked",
        "on_mealPlanSelectedDayRecipesList_itemClicked",
        "on_mealPlanSelectedDayRecipesList_itemActivated",
        "on_mealPlanDeleteButton_clicked",
        "on_savedRecipeName_textEdited",
        "on_recipeSearchbox_cursorPositionChanged",
        "arg2"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_mealPlanAddRecipeButton_clicked'
        QtMocHelpers::SlotData<void()>(35, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_mealPlanRecipesList_itemClicked'
        QtMocHelpers::SlotData<void(QListWidgetItem *)>(36, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 14, 15 },
        }}),
        // Slot 'on_mealPlanCalender_selectionChanged'
        QtMocHelpers::SlotData<void()>(37, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_mealPlanRemoveRecipeButton_clicked'
        QtMocHelpers::SlotData<void()>(38, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_mealPlanSelectedDayRecipesList_itemClicked'
        QtMocHelpers::SlotData<void(QListWidgetItem *)>(39, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 14, 15 },
        }}),
        // Slot 'on_mealPlanSelectedDayRecipesList_itemActivated'
        QtMocHelpers::SlotData<void(QListWidgetItem *)>(40, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 14, 15 },
        }}),
        // Slot 'on_mealPlanDeleteButton_clicked'
        QtMocHelpers::SlotData<void()>(41, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_savedRecipeName_textEdited'
        QtMocHelpers::SlotData<void(const QString &)>(42, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 21 },
        }}),
        // Slot 'on_recipeSearchbox_cursorPositionChanged'
        QtMocHelpers::SlotData<void(int, int)>(43, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 21 }, { QMetaType::Int, 44 },
        }}),
    };
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 25: _t->on_tabWidget_tabBarClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 26: _t->on_mealPlanAddRecipeButton_clicked(); break;
        case 27: _t->on_mealPlanRecipesList_itemClicked((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        case 28: _t->on_mealPlanCalender_selectionChanged(); break;
        case 29: _t->on_mealPlanRemoveRecipeButton_clicked(); break;
        case 30: _t->on_mealPlanSelectedDayRecipesList_itemClicked((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        case 31: _t->on_mealPlanSelectedDayRecipesList_itemActivated((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        case 32: _t->on_mealPlanDeleteButton_clicked(); break;
        case 33: _t->on_savedRecipeName_textEdited((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 34: _t->on_recipeSearchbox_cursorPositionChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
}
